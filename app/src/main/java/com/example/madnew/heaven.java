...
public class heaven extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cupcakeName.setText("HEAVEN");
        imageView.setImageResource(R.drawable.heaven);

        addtoOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sumintent = new Intent(heaven.this,SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity == 0){
                    Toast.makeText(heaven.this, "cant decrease quantity < 4", Toast.LENGTH_SHORT).show();
                }
                else{
                    quantity--;
                    displayQuantity();
