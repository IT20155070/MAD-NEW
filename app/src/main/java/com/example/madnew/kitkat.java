...
public class kitkat extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cupcakeName.setText("KITKAT");
        imageView.setImageResource(R.drawable.kitkat);

        addtoOrder.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sumintent = new Intent(kitkat.this,SummaryActivity.class);
        ...
        minusquantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(quantity == 0){
                    Toast.makeText(kitkat.this, "cant decrease quantity < 4", Toast.LENGTH_SHORT).show();
                }
                else{
                    quantity--;
                    displayQuantity();
