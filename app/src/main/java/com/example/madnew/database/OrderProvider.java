...
public class OrderProvider extends ContentProvider {
    ...
    private Uri insertCart(Uri uri, ContentValues values) {
        ...
        String cake_name = values.getAsString(OrderContract.OrderEntry.COLUMN_NAME);
        if(cake_name == null) {
        ...
        String name = values.getAsString(OrderContract.OrderEntry.COLUMN_PRICE);
        if(name == null) {
            throw new IllegalArgumentException("Name is Required");
        }

        String address = values.getAsString(OrderContract.OrderEntry.COLUMN_PRICE);
        if(address == null) {
            throw new IllegalArgumentException("Address is Required");
        }

        String phone = values.getAsString(OrderContract.OrderEntry.COLUMN_PRICE);
        if(phone == null) {
            throw new IllegalArgumentException("Phone No is Required");
        }

        String date = values.getAsString(OrderContract.OrderEntry.COLUMN_PRICE);
        if(date == null) {
